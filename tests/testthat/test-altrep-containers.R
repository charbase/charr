...
test_that("UTF-8 and UTF-16 containers round-trip charvec input", {
...
test_that("containers preserve stringi encoding normalization", {
...
test_that("only the UTF-8 container strips a leading BOM", {
...
test_that("owned String8 self-assignment keeps its bytes", {
  output <- call_container_test("C_ci_test_String8_assignment")
