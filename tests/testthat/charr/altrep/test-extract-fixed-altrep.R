...
extract_first_fixed <- function(...) charr:::ci_extract_first_fixed(...)
extract_all_fixed <- function(...) charr:::ci_extract_all_fixed(...)


test_that("fixed extract emits multibyte Reader slices with exact encodings", {
  strings <- charr:::ci_trim_both(c(" éaé ", " 🙂x🙂 ", " üü ", " abc "))
