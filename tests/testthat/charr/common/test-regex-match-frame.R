...
test_that("regex match preserves zero-output pattern handling", {
  ...
  expect_identical(
    charr:::ci_match_first_regex(character(), named_pattern),
    stringi::stri_match_first_regex(character(), named_pattern)
  )
  expect_error(
    charr:::ci_match_first_regex(character(), "["),
    "U_REGEX_MISSING_CLOSE_BRACKET"
  )

  expect_identical(
    charr:::ci_match_all_regex(character(), "["),
...
test_that("regex match preserves empty-pattern warning counts", {
  ...
  expect_identical(
    regex_match_frame_conditions(
      charr:::ci_match_first_regex(first_subject, "")
    ),
    regex_match_frame_conditions(
  ...
  expect_identical(
    regex_match_frame_conditions(
      charr:::ci_match_first_regex(character(), patterns)
    ),
    regex_match_frame_conditions(
  ...
  expect_identical(
    regex_match_frame_conditions(
      charr:::ci_match_all_regex(character(), patterns)
    ),
    regex_match_frame_conditions(
