...
The corpus is multilingual sentences from [Tatoeba](https://tatoeba.org/), sampled in 1,000,000, 100,000 and 10,000 sizes. Each prefix exists twice, once as an ordinary character vector and once as a `charvec`, an optimized ALTREP class (see [charport](https://charport.github.io/charport/)).
...
Both optimized backends are faster than or equivalent to the reference on all 67 operations. Base medians run from 1.01× to 3.33×, ALTREP medians from 1.03× to 13.6×.
...
- stringi 1.8.7.9001, forked, [gagolews/stringi](https://github.com/gagolews/stringi) at `19e9586ba39b3320df49355e32bd18d74ed6098f` (2026-06-03)
